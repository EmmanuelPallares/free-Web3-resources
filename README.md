...
Web 3.0, also known as the Semantic Web or the Intelligent Web,
refers to the next generation of the World Wide Web. It aims to provide a more intelligent,
connected, and decentralized web experience, with a focus on data and privacy.

Unlike Web 2.0, which primarily involved user-generated content and social media, Web 3.0 is
characterized by machine-generated content, machine learning, and artificial intelligence.
It also emphasizes the use of decentralized systems, such as blockchain technology, to create
a more secure and transparent internet experience.
...
- [Ethereum org] (https://ethereum.org/) The official website of the Ethereum blockchain provides a lot of information on dApps and smart contracts. It also has a tutorial on how to build your first dApp.
- [Solidity] (https://Solidity.readthedocs.io) Solidity is the programming language used to write smart contracts on the Ethereum blockchain. The Solidity documentation website provides a detailed guide on how to write and deploy smart contracts.
- [CryptoZombies] (https://CryptoZombies.io) This is an interactive coding tutorial that teaches you how to build a simple dApp game on the Ethereum blockchain.
